...
//плотность веро€тности временных интервалов при учете быстрых послеимпульсов и темновых токов
...
//получить значение dt, которое имеет плотность веро€тности f_dt_dc_fast(dt)
double Get_dt()
{
	double x;
	double a = 0;
...
int main()
{
	...
	for (int k = 0; k < cycles; k++)
	{
		...
		// выбрать закон распределени€ временных интервалов
		//double dt = 20;
