...
int main(int argc, char *argv[])
{
	...
	if (argc == 1)
	{
		...
		Monostate::dir_name = "D:\\Data_work\\tektronix_signal\\SiPM_Hamamatsu_50C\\290K\\54_65V\\"; // my PC
		// Monostate::dir_name = "/mnt/scratch/ws/vpoleynikov/201601261856ws1/MPPC_S10362-11-100C/285K/69_65V/"; // NSU Cluster
		RootFit::threshold_amp_start = -0.02;
				...
				time_3_c = -100;
                   ...
                   //without graphs
                    ...
                    //*gr_der2_tree_fit1 = *(Fit_single->gr_der2);
                       ...
                       if (/*Fit_single->GetChi2PerDof() > 1.5 && false*/ true)
				{
					...
					dt_2_ab = fabs(Fit_double->fitFcn->GetParameter(6) - Fit_double->fitFcn->GetParameter(1));
	...
	cout << "Total execution time is (in s): " << (double)(clock() - t_0) / CLOCKS_PER_SEC << endl;
