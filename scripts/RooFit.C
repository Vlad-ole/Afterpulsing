...
{
   RooRealVar t("t","time", 1, 50000);
   
   RooRealVar nu_f("nu_f","time", 1.0 / 25, 1.0/ 50, 1.0 / 5);
   //RooRealVar nu_s("nu_s","time", 1.0 / 120, 1.0 / 250, 1.0 / 20);
   RooRealVar nu_dc("nu_dc","time", 5.61462e-005, 0, 0.010);
 
	RooRealVar p_s("p_s","time", 0, 0, 0);
	RooRealVar nu_s("nu_s","time", 0, 0, 0);
	//RooRealVar nu_dc("nu_dc","time", 3.34E-04, 3.34E-04, 3.34E-04);
   
   //RooRealVar p_s("p_s","time", 0.1, 0, 0.5);
   RooRealVar p_f("p_f","time", 0.1, 0, 0.5);
